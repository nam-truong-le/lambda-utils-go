module github.com/nam-truong-le/lambda-utils-go
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/textract v1.19.2
	...
	github.com/vietnam-immigrations/go-utils/v2 v2.5.0
